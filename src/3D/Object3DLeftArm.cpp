...
Object3DLeftArm::Object3DLeftArm(Point3D root){
...
void
Object3DLeftArm::makeArm(Point3D root){
...
void
Object3DLeftArm::assemblyActors(vector<vtkActor*>& actors,vector<vtkAssembly*>& assemblies){
  ...
  addNode(assemblies[SHOULDERZ],5000/*,AxesRotations(0,0,-1)*/);
  addNode(assemblies[SHOULDERY],5001/*,AxesRotations(0,1,0)*/);
  addNode(assemblies[SHOULDERX],5002/*,AxesRotations(-1,0,0)*/);
  
  addNode(assemblies[ELBOWX],5003/*,AxesRotations(-1,0,0)*/);
  addNode(assemblies[ELBOWY],5004/*,AxesRotations(0,1,0)*/);
  
  addNode(assemblies[WRISTX],5005/*,AxesRotations(-1,0,0)*/);
  addNode(assemblies[KNUCKLEX],5006/*,AxesRotations(1,0,0)*/);
  
  
  (_robotList[5000]).initValue = 138;
  (_robotList[5001]).initValue = 139;
  (_robotList[5002]).initValue = 125;
  (_robotList[5003]).initValue = 127;
  (_robotList[5004]).initValue = 106;
  (_robotList[5005]).initValue = 115;
  (_robotList[5006]).initValue = 117;
